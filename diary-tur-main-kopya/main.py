...
def login():
        ...
        if request.method == 'POST':
            ...
            for user in users_db:
                ...
                error = 'Böyle kullanıcı adına ve şifreye sahip hesap bulunamadı. Kullanıcı adını veya şifreyi veya her ikisini de yanlış yazmış olmalısınız. Lütfen tekrar deneyin!!!'
